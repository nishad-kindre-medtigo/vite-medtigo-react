    ...
    <>
      ...
      <Grid container rowSpacing={2} columnSpacing={2}>
        {[...Array(cards)].map((_, index) => (
          <Grid size={12} sm={grid} key={index}>
            <Box
              sx={{
            ...
            >
              <Grid container>
                <Grid size={{ xs: 8, sm: 6}} display='flex' gap={1}>
                ...
                <Grid size={{ xs: 4, sm: 6}} display='flex' justifyContent="flex-end" alignItems="flex-end" gap={1} >
                  {!isSmallMobile && (
                    <>
                      <Skeleton variant="circular" animation="wave" height={24} width={24} sx={{ background: '#E9F2FC' }}/>
                      <Skeleton variant="circular" animation="wave" height={24} width={24} sx={{ background: '#E9F2FC' }}/>
